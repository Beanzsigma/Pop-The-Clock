...
- AI helped fix the hue-changing background
- A bit of AI assistance was used to help fix/debug parts of the code. 
- AI helped with an early attempt at the text animation, though a friend got it working at the end
