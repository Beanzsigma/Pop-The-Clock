...
highlightafter = [None]
afterid = None
badgesearned = {"novice": False, 'specialnovice': False, 'specialpro': False, 'specialhacker': False, 'specialgod': False, 'pro': False, 'hacker': False, 'god': False}
badgesequipped = {'novice': False, 'specialnovice': False, 'specialpro': False, 'specialhacker': False, 'specialgod': False, 'pro': False, 'hacker': False, 'god': False}
app = ctk.CTk()
...
def set_app_icon():
    app.iconphoto(False, tk_icon)
set_app_icon()
app.after(250, set_app_icon)
def loadsavedata():
...
def gohome(e=None):
    ...
    needle_angle = 0
    needledir = 1
    wasspecial = specialmode[0]
    instantlose[0] = False
    specialmode[0] = False
    startclock[0] = 30
    clockminutes[0] = 30
    main(straight_to_noob=True, straight_to_special=wasspecial)
countdownitems = []
clocktextids = {}
togotextids = {}
def updatetogo():
...
def showspecialcode(gen):
    ...
    specialontarget[0] = False
    numshdw = canvas.create_text(353, y0+boxh//2+3, text=codetext, font=("Press Start 2P", codefont), fill='#968d8d', width=boxw-60, justify='center')
    num = canvas.create_text(350, y0+boxh//2, text=codetext, font=("Press Start 2P", codefont), fill='white', width=boxw-60, justify='center')
...
def highlightnumb(gen=None):
        ...
        highlightafter[0] = app.after(10, lambda: highlightnumb(generation[0]))
fading = {}
def showwinspecialnoob():
    gameover[0] = True
    badgesearned['specialnovice'] = True
    savedata()
    inputlocked[0] = True
    dimimg = Image.new("RGBA", (700, 819), (0, 0, 0, 140))
    dimphoto = ImageTk.PhotoImage(dimimg)
    ...
    specialnoviceimg = Image.open(getpath("Assets/main/specialnovice.png"))
    ...
    def refresheqdis():
        if badgesequipped['specialnovice']:
    ...
    refresheqdis()
    def eqbutton(e=None):
        badgesequipped['specialnovice'] = not badgesequipped['specialnovice']
        refresheqdis()
        savedata()
    def eqent(e):
        if badgesequipped['specialnovice']:
...
def showwinspecialpro():
    ...
    specialproimg = Image.open(getpath("Assets/main/specialpro.png"))
    ...
    wincanvas.tag_bind(equip, "<Button-1>", eqbutton)
    wincanvas.tag_bind(equipshdw, "<Button-1>", eqbutton)
def showwinspecialhacker():
    gameover[0] = True
    badgesearned['specialhacker'] = True
    savedata()
    inputlocked[0] = True
    dimimg = Image.new("RGBA", (700, 819), (0, 0, 0, 140))
    dimphoto = ImageTk.PhotoImage(dimimg)
    ...
    specialhackerimg = Image.open(getpath("Assets/main/hackerspecial.png")).resize((280, 280))
    ...
    equip = wincanvas.create_text(350, 740, text="EQUIP", font=("Press Start 2P", 22), fill='white')
    def refresheqdis():
        if badgesequipped['specialhacker']:
            wincanvas.itemconfig(equip, fill='#74d172')
            wincanvas.itemconfig(equipshdw, fill='#426343')
        else:
            wincanvas.itemconfig(equip, fill='white')
    ...
    refresheqdis()
    def eqbutton(e=None):
        badgesequipped['specialhacker'] = not(badgesequipped['specialhacker'])
        refresheqdis()
        savedata()
    def eqent(e):
        if badgesequipped['specialhacker']:
    ...
    wincanvas.tag_bind(equip, "<Button-1>", eqbutton)
    wincanvas.tag_bind(equipshdw, "<Button-1>", eqbutton)
def showwinspecialgod():
    gameover[0] = True
    badgesearned['specialgod'] = True
    savedata()
    inputlocked[0] = True
    dimimg = Image.new("RGBA", (700, 819), (0, 0, 0, 140))
    dimphoto = ImageTk.PhotoImage(dimimg)
    ...
    wincanvas.create_text(353, 43, text="SPECIAL", font=("Press Start 2P", 33), fill='#968d8d')
    wincanvas.create_text(350, 40, text="SPECIAL", font=("Press Start 2P", 33), fill='white')
    wincanvas.create_text(363, 181, text='Do you\nknow what\ngrass is?', font=("Press Start 2P", 23), fill="#968d8d", anchor='center')
    wincanvas.create_text(360, 178, text='Do you\nknow what\ngrass is?', font=("Press Start 2P", 23), fill='white', anchor='center')
    wincanvas.create_text(353, 353, text='     You have\n     earned the\n SPECIAL GOD badge', font=("Press Start 2P", 18), fill='#968d8d', anchor='center')
    wincanvas.create_text(350, 350, text='     You have\n     earned the\n SPECIAL GOD badge', font=("Press Start 2P", 18), fill='white', anchor='center')
    specialgodimg = Image.open(getpath("Assets/main/specialgod.png")).resize((295, 200))
    ...
    refresheqdis()
    def eqbutton(e=None):
        badgesequipped['specialgod'] = not(badgesequipped['specialgod'])
        refresheqdis()
        savedata()
    def eqent(e):
        if badgesequipped['specialgod']:
...
def showwin():   
    ...
    noviceimg = Image.open(getpath("Assets/main/novice.png"))
    ...
    if specialmode[0]:
       if gamemode[0] == 'hacker':
           ...
           showanimatedtext('hjkz2', "⚠︎", 620, 100, amplitude=6, speed=0.12, wavelength=0.4, condition=lambda: gamemode[0]=='hacker', basecolor=(255, 140, 0), pulsecolor=(255, 30, 30), font=('Arial', 22))
            ...
            showanimatedtext('special', "⠃⠗⠁⠊⠇⠇⠑", 83, 638, amplitude=3.5, speed=0.12, wavelength=0.3, condition=lambda: specialmode[0] and gamemode[0] == 'noob', font=("Arial", 20), basecolor=(255, 255, 255), pulsecolor=(0, 200, 255))
            showanimatedtext('special2', "⏱", 620, 100, amplitude=3.5, speed=0.12, wavelength=0.3, condition=lambda: specialmode[0] and gamemode[0] == 'noob', font=("Arial", 26), basecolor=(255, 255, 255), pulsecolor=(0, 200, 255))
...
def main(canvas_img_unused=None, canvasbg_unused=None, straight_to_noob=False, straight_to_special=False):
    ...
    animate()
    badgehieght = 101
    badgeorder = ['novice', 'specialnovice', 'specialpro', 'specialhacker', 'specialgod', 'pro', 'hacker', 'god']
    badgeimgfiles = {'novice': getpath("Assets/main/novice.png"), 'specialnovice': getpath("Assets/main/specialnovice.png"), 'specialpro': getpath("Assets/main/specialpro.png"),
                      'specialhacker': getpath("Assets/main/hackerspecial.png"),
                      'specialgod': getpath("Assets/main/specialgod.png"), 'pro': getpath("Assets/main/pro.png"), 'hacker': getpath("Assets/main/hacker.png"), "god": getpath("Assets/main/god.png")}
    equippedpos = (9, 20)
    ...
    def badgescreen(e=None):
        ...
        orginalpro = Image.open(getpath("Assets/main/pro.png"))
    ...
    def badgescreen2(e=None):
        ...
        specialhackerimg = Image.open(getpath("Assets/main/hackerspecial.png")).resize((265, 265))
        imgspecialhacker = ImageTk.PhotoImage(specialhackerimg)
    ...
    def clickclassic(e=None):
        ...
        noobclassic = Image.open(getpath('Assets/Classic/noob.png')).resize((160, 160))
        ...
        proclassic = Image.open(getpath('Assets/Classic/sweat.png')).resize((185, 185))
        ...
        hackerclassic = Image.open(getpath("Assets/Classic/hackerclass.png")).resize((280, 280))
        ...
        godclassic = Image.open(getpath('Assets/Classic/godclass.png')).resize((480, 480))
    ...
    def clickspecial(e=None):
        ...
        menucanvas.tag_bind(godmodeshdw, "<Enter>", godent)
        menucanvas.tag_bind(godmode, "<Enter>", godent)
        menucanvas.tag_bind(godmode, "<Button-1>", startspecialgod)
        menucanvas.tag_bind(godmodeshdw, "<Button-1>", startspecialgod)
    menucanvas.tag_bind(spec, "<Button-1>", clickspecial)
    menucanvas.tag_bind(specshdw, "<Button-1>", clickspecial)
    if straight_to_noob:
        if straight_to_special:
            clickspecial()
        else:
            clickclassic()
loadsavedata()
